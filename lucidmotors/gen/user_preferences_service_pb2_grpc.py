...
class UserPreferencesService(object):
    ...
    def CreateUserPreferences(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mobilegateway.protos.UserPreferencesService/CreateUserPreferences',
    ...
    def GetUserPreferences(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mobilegateway.protos.UserPreferencesService/GetUserPreferences',
    ...
    def GetUserPreferencesCommitID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mobilegateway.protos.UserPreferencesService/GetUserPreferencesCommitID',
            user__preferences__service__pb2.Empty.SerializeToString,
            user__preferences__service__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SetUserPreferences(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mobilegateway.protos.UserPreferencesService/SetUserPreferences',
            user__preferences__service__pb2.Empty.SerializeToString,
            user__preferences__service__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
