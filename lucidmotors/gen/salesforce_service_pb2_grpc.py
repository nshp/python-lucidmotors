...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in salesforce_service_pb2_grpc.py depends on'
...
def add_SalesforceServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('mobilegateway.protos.SalesforceService', rpc_method_handlers)
